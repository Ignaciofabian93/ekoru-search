pipeline {
  ...
  stages {
    ...
    stage('Deploy Production') {
      ...
      steps {
        sh '''
          cp /opt/ekoru/secrets/ekoru-search/.env.prod ${WORKSPACE}/.env.prod
